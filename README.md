...
> 🚧 **Status:** In progress — built step by step as a learning + portfolio project focused on strengthening core HTML, CSS, and JavaScript skills.
...
- Vanilla JavaScript
- AI image generation via Replicate (planned)
...
## 👩‍💻 Author
Built by Savaira Ameer — learning frontend development one commit at a time.
